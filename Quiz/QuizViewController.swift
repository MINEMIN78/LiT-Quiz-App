...
class QuizViewController: UIViewController,AVAudioPlayerDelegate  {
    ...
    override func viewDidLoad() {
        ...
        //------------------------ここから下にクイズを書く------------------------//
        quizArray.append(["去年のセ・リーグ優勝チームは？","巨人","中日","阪神",1])
        ...
        quizArray.append(["野球のポジションで、6番と表されるポジションは？","左翼手","遊撃手","右翼手",2])
        quizArray.append(["2010,2011年の２年連続でリーグ優勝を果たしたチームはどこ？","中日","巨人","ソフトバンク",1])
